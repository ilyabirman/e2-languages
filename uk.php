...
function e2l_load_strings () {
  ...
  'gs--following-folders-missing' => 'Не знайдено цих папок із дистрибутива двигуна:',
  'gs--could-not-create-them-automatically' => 'Їх не вдалось створити автоматично через брак прав. Завантажте на сервер повний дистрибутив.',
  'gs--and-reload-installer' => 'І перевантажте встановлювач',
  'fb--begin' => 'Почати блог',
  'fb--retry' => 'Спробувати ще раз',
  'gs--db-parameters' => 'Параметри бази даних, надані хостером',
  'gs--ask-hoster-how-to-create-db' => 'Уточніть у хостера, як створити базу, якщо її немає',
  'er--double-check-db-params' => 'Перевірте ще раз реквізити бази даних',
  'gs--instantiated-version' => 'Інстанційована версія',
  'pt--installer-loading' => 'Завантаження...',
  'gs--database' => 'База даних',
  'gs--password-for-blog' => 'Пароль, який ви хотіли б використовувати для доступу до блогу',
  'gs--data-exists' => 'У цій базі вже існує блог. Встановлювач просто підключиться до неї.',
  'er--db-data-incomplete' => 'У цій базі вже є частина даних блогу. Можливо, з нею використовувалась інша версія Егеї. Встановіть Егею тієї ж версії, що й у базі, а потім за потреби оновіть. Для чистого встановлення потрібна чиста база.',

  // diags
  'et--fix-permissions-on-server' => 'Налаштуйте права на сервері',
  'gs--enable-write-permissions-for-the-following' => 'Будь ласка, дайте права на запис сюди:',
  ...
  'er--error-updating-post' => 'Помилка при зміні допису',
  'er--error-deleting-post-tag-info' => 'Помилка при видаленні даних про теги допису',
  'er--wrong-datetime-format' => 'Неправильний формат дати-часу. Повинно бути: «ДД.ММ.РРРР ГГ:ХХ:СС»',
  'er--cannot-get-post-from-db' => 'Не вдалось дістати допис із бази',
  'er--images-only-supported' => 'Підтримуються тільки зображення',
  'er--cannot-create-thumbnail' => 'Не вдалось створити зменшене зображення',
  'er--cannot-upload' => 'Не вдалось завантажити файл',
  'ff--title' => 'Назва',
  'ff--text' => 'Текст',
  ...
  'ff--gmt-offset' => 'Різниця із Гринвічем',
  ...
  'gs--draft-will-be-deleted' => 'Чернетка «$[draft]» видалиться.',
  ...
  'gs--unsubscription-didnt-work' => 'Чомусь не спрацювала відписка',          
  'gs--comment-not-found' => 'Коментар не знайдено',
  'gs--post-not-found' => 'Допис не знайдено',
  'gs--comment-too-long' => 'Надто довгий коментар',
  'gs--comment-too-long-description' => 'Ви відправили надто довгий коментар, тому його не збережено.',
  'gs--comment-double-post' => 'Повторний коментар',
  'gs--comment-double-post-description' => 'Ви відправили коментар двічі, збережено тільки один із них.',
  'gs--comment-spam-suspect' => 'Коментар схожий на спам',
  'gs--comment-spam-suspect-description' => 'Пробачте, але робот вирішив, що це спам, тому коментар не відправлено.',
  ...
  'ff--email' => 'Ел. пошта',
  'gs--email-wont-be-published' => 'адреса не опублікується',
  ...
  'gs--no-comments' => 'коментарі відсутні',
  ...
  'tt--edit-tag' => 'Змінити параметри та опис тегу',
  'gs--tagged' => 'з тегом',
  ...
  'er--cannot-rename-tag' => 'Таке ім’я чи вигляд в адресному рядку вже використовуються іншим тегом',
  'ff--tag-name' => 'Назва',
  'ff--tag-urlname' => 'В адресному рядку',
  'ff--tag-description' => 'Опис',
  'gs--tag-will-be-deleted-notes-remain' => 'Тег «$[tag]» видалиться із нотаток, але самі вони залишаться.',
  ...
  'gs--search-query-empty' => 'Текст для пошуку порожній, напишіть хоч щось',
  'gs--search-query-too-short' => 'Надто короткий текст, напишіть хоча б 4 букви.',
  ...
  'gs--sessions-description' => 'Коли ви входите зі своїм паролем на кількох пристроях чи у кількох браузерах, тут показується список усіх таких сесій. Якщо якась із них здається вам підозрілою, завершіть усі сесії окрім поточної, а потім змініть пароль до блогу.',
  ...
  'ff--language' => 'Мова',
  'ff--theme' => 'Оформлення',
  'ff--theme-how-to' => 'Як створити власну тему?',
  'ff--theme-selector-wants-js' => 'Для вибору теми оформлення увімкніть у браузері підтримку скриптів (JavaScript).',
  'ff--posts' => 'Дописи',
  'ff--items-per-page-after' => 'на сторінку',
  'ff--show-sharing-buttons' => 'Показувати кнопки відправлення у соцмережі',
  ...
  'fb--connect-to-this-db' => 'Під’єднуватись з цими параметрами',
  'er--cannot-save-data' => 'Не вдається зберегти дані',
  ...
  'pt--welcome-text-href-write' => 'Створіть допис',
  'pt--welcome-text-or' => ' або ',
  'pt--welcome-text-href-settings' => 'налаштуйте щось',
  ...
  'gs--e2-autodetects-timezone' => 'При публікації часовий пояс зазвичай визначається автоматично. Якщо не вдасться, використається обраний тут часовий пояс.',
  ...
  'em--comment-reply' => '$[note-title] (відповідь від $[blog-author])',
  'em--created-automatically' => 'Лист створено автоматично.',
  'em--unsubscribe' => 'Відписатись від цього обговорення',
  'em--reply' => 'Відповісти',
  'em--comment-replied-at' => 'Коментар із відповіддю автора',
  ...
  'er--cannot-connect-to-db' => 'Не можу з’єднатись із базою даних',
  'er--error-in-query' => 'Помилка при запиті',
  'er--error-occurred' => 'Сталась помилка',
  ...
  'gs--good-blogs' => 'Добрі блоги та сайти',
...
function e2lstr_monthname ($number, $modifier = '') {
  if ($modifier == 'genitive') {
    ...
    $tmp = array (
      'груд', 'січ', 'лют', 'бер', 'квіт', 'трав', 'черв',
      'лип', 'серп', 'вер', 'жовт', 'лист', 'груд', 'січ'
    );
  } else {
    $tmp = array (
...
function e2lstr_cardinal ($number, $modifier = '', $string_id) {
  ...
  $what = $number;
  if ($string_id == 'pt--n-posts') $what = $number .' допис(,и,ів)';
  if ($string_id == 'tt--minutes-ago') $what = $number .' хвилин(а,и,)';
  if ($string_id == 'tt--hours-ago') $what = $number .' годин(а,и,)';
  if ($string_id == 'gs--n-comments') $what = $number .' коментар(,і,ів)';
